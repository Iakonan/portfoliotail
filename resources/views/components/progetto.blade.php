<x-layout>
    <section class="grid md:grid-cols-2 justify-center items-center gap-4 m-12 mb-9" style="min-height: 900px">
        ...
        <div class="flex justify-center items-center text-center">
            <div>
                ...
                <p class="text-lg font-semibold uppercase text-justify">
                    {{ $project['description'] }}
                </p>
            </div>
        </div>
    </section>
    <section class="grid md:grid-cols-2 justify-center items-center gap-4 m-12 mb-72" style="min-height: 900px">
