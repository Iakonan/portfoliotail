        ...
        <div class="flex justify-center items-center text-center md:col-span-1 mb-12">
            <div>
                ...
                <p class="text-lg font-semibold uppercase text-justify whitespace-pre-line">
                    ...
                    Attualmente, lavoro come impiegato data entry e addetto alla sala posta, ma da novembre 2023 ho iniziato un nuovo percorso nella programmazione web e mobile. Dopo aver seguito un corso con Aulab e ottenuto la certificazione, ho continuato a studiare come autodidatta. Al momento, utilizzo <span class="font-extrabold text-lime-400">Laravel</span>, <span class="font-extrabold text-lime-400">PHP</span>, <span class="font-extrabold text-lime-400">css</span>, <span class="font-extrabold text-lime-400">Bootstrap</span> e <span class="font-extrabold text-lime-400">JavaScript</span>, con l&apos;obiettivo di espandere le mie competenze a <span class="font-extrabold text-lime-400">Flutter</span>, <span class="font-extrabold text-lime-400">TypeScript</span>, <span class="font-extrabold text-lime-400">Tailwind CSS</span>, <span class="font-extrabold text-lime-400">Angular</span> e <span class="font-extrabold text-lime-400">React</span>.
